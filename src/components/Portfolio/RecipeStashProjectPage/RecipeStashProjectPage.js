...
function RecipeStashProjectPage() {
  ...
  return (
      <div className="project-page">
        ...
        <p>
          Built with React, TypeScript, Node.js, Express, Material-UI, and PostgreSQL, Recipe Stash is a fullstack single page application which involved a lot of software design concepts 
        ...
        <p>I'm using AWS S3 for storing the recipe images.</p>
        <p>React doesn't come out of the box with a good approach to localizing front end service calls, so after having worked in the Angular eco system
          I found it all but necessary to roll my own pseudo-approach to defining and exporting services for React (minus, of course, the dependency injection benefits that come with Angular).
        </p>
