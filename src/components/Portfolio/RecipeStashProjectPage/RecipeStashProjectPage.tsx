...
const RecipeStashProjectPage = () => {
  return (
    <div className="project-page">
      ...
      <h3>
        Built with React, TypeScript, Node, AWS, MUI, and Postgres, Recipe Stash is a fullstack 
        SPA whereby users can add recipes, duplicate them, tag them with various categories (sugar-free, dairy-free, vegan, etc), & upload pictures. 
        For fun (and not because this is necessarily a good idea), I decided to handle authentication myself, using session-based authentication after being heavily influenced by 
        this<a target="_blank" href="http://cryto.net/~joepie91/blog/2016/06/13/stop-using-jwt-for-sessions/" style={{marginLeft: '3px'}}>very convincing article against using JWTs for authentication purposes</a>. 
      </h3>
      ...
      <div className="button-holder">
          ...
          <a target="_blank" href="https://github.com/baileypownell/recipe_stash"><button>View Source Code</button></a>
      </div>
    </div>
  )
}
